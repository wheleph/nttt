...
class TestTagTrimming(unittest.TestCase):
    def test_inside_spaces(self):
        ...
        self.assertEqual(tag_trimming.trim_html_tags(init, "off"), out)
    ...
    def test_asymmetric_spaces(self):
        ...
        self.assertEqual(tag_trimming.trim_html_tags(init_a, "off"), out)
        self.assertEqual(tag_trimming.trim_html_tags(init_b, "off"), out)
